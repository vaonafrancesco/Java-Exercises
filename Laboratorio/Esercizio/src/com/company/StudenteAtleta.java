...
public class StudenteAtleta extends Studente implements IAtleta{
    ...
    String disciplina;
    IAtleta.Rilevanza rilevanza;
    Studente studente;

    public StudenteAtleta(String nome, String cognome, String CF, int annoNascita, String uni, Laurea corsoLaurea, String disciplina, IAtleta.Rilevanza r) {
